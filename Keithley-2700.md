...
The Keithley utilises the [convert record](https://github.com/ISISComputingGroup/ibex_developers_manual/wiki/Convert-Record) to interpolate a temperature from a resistance reading. It uses a Spline fit to do this, implemented in `User1DTableSub.c` in the support directory. 
