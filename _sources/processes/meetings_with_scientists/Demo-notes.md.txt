# First-time demos of IBEX to scientists

```{note}
All instruments now have IBEX, so this process is unlikely to be needed for existing instruments.

For existing instruments, use [regular demo documentation](Regular-Demos-of-IBEX-to-Scientists)
```
