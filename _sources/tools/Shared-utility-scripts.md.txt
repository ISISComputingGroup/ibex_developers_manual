...
The repository was created in response to a discussion held in the retrospective 2022.09.07 to remove the need for a check to scan repositories to ensure submodules have correctly been updated.
