...
As described in the physics background page ([Reflectometers Science](reflectometry/design_docs/Reflectometers-Science)), we need to calculate where a beamline should physically be based on higher level parameters, and track a changing beam path with multiple components. The user workflows we need to support are:
...
{#reflectometry_footprint_calculator}
...
**For more implementation details see the [Beamline Configuration page](reflectometry/Reflectometry-Configuration)**
...
- [CRISP](reflectometry/beamlines/Reflectomtery-IOC-CRISP)
- [INTER](reflectometry/beamlines/Reflectomtery-IOC-INTER)
- [POLREF](reflectometry/beamlines/Reflectomtery-IOC-POLREF)
- [SURF](reflectometry/beamlines/Reflectomtery-IOC-SURF)


## Troubleshooting

see [Reflectometry Troubleshooting and FAQ](reflectometry/Reflectometry-Troubleshooting-and-FAQ)
