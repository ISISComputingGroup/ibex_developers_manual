...
The galil motors can be configured to run one of the multiple homing routines. These routines are documented in the [readme of the galil repository](https://github.com/ISISComputingGroup/EPICS-galil/tree/master/GalilSup/Db); there is extra documentation on the [oscillating collimator page for those routines](../../motor_extensions/MERLIN,-LET-and-WISH-Oscillating-radial-collimators).
