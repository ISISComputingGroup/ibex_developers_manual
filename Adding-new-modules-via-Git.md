...
1. Add the new repository as a submodule:
   ...
   If you forget to do this, then you can edit `.gitmodules` and add a `branch = main` line to the submodule (see other entries in file for example), then commit and push this change.
