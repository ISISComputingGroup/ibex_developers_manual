...
1. Open the Java Control panel and make sure that [Java Auto Update](https://www.java.com/en/download/help/java_update.xml#sched) is disabled (i.e. make sure the "Check for Updates Automatically" checkbox is unchecked).
