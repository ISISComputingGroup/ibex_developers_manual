...
## Automatically
If you're building a new StreamDevice IOC you can use the [IOC Genertor script for info see the wiki](https://github.com/ISISComputingGroup/IBEX_device_generator).
