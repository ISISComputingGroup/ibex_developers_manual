...
Note: the instructions [here](https://github.com/ISISComputingGroup/ibex_developers_manual/wiki/Developer-Server-Build) may be much quicker than building EPICS yourself manually. The EPICS build on the build server contains all the git submodules so should work as usual. 
