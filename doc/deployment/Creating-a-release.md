...
1. Run the {ref}`instrumentdeployyaml` playbook on any test machines which will be used for manual system testing. Before running the playbook, ensure that `ibex_version` (under `vars:`) is up-to-date.
