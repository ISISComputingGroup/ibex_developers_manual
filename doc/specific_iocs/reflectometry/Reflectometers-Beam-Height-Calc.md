...
In a [reflectometry instrument](design_docs/Reflectometers) the height above the straight through beam can be calculated using the following diagram. It is based on the incoming angle of that beam. 

![Image](images/Non-small_angle_approx.png)

If there are two angles use the following calculation:

![Image](images/Non_small_angle_approx_2_angles.png)
...
![General intersection](images/GeneralIntersect.png)
